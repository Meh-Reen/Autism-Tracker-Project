...
# --- THIS CREATES THE DATABASE AUTOMATICALLY IF IT DOESN'T EXIST ---
def setup_database():
    ...
    # Insert data only if empty (prevents duplicates on refresh)
...
# --- YOUR DASHBOARD QUERIES (same as before) ---
